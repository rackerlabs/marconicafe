...
def print_cafe_mug():
    print('\n'.join(["\t\t   _ _ _",
                     ...
                     "\t\t=== MarconiCAFE ==="]))
    print("========================================================")
    print("MarconiCAFE Framework installed")
    print("========================================================")
...
setup(
    ...
    version='0.0.1',
    description=(
        'MarconiCAFE is an implementation of the Open CAFE Framework '
        'specifically designed to test deployed versions of Marconi'),
    long_description='{0}\n\n{1}'.format(
        open('README.md').read(),
